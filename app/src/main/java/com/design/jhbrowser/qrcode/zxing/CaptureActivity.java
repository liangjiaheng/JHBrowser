...
import com.design.jhbrowser.qrcode.LightControl;
        ...
        btn_light_control.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isShow) {
                    ...
                    CustomToastUtils.showToast(getApplicationContext(), "闪光灯关闭");
                    mLightControl.turnOff();
                } else {
                    isShow = true;
                    btn_light_control.setBackgroundResource(R.mipmap.torch_on);
                    mLightControl.turnOn();
                    CustomToastUtils.showToast(getApplicationContext(), "闪光灯开启");
                }
            }
        });
    }
